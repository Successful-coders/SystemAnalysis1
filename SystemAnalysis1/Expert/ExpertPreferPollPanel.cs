...
{
    class ExpertPreferPollPanel : Panel
    {
        ...
        public ExpertPreferPollPanel(int index, Alternative alternative, OnAnsweredHandler answeredHandler, int alternativesCount) : base()
        {
            questionIndex = index;
            ...
            estimateNumeric.Maximum = alternativesCount;
            estimateNumeric.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            estimateNumeric.Value = new decimal(new int[] {
            1,
            0,
            0,
            0});
        ...
        public ExpertPreferPollPanel(int index, Alternative alternative, OnAnsweredHandler clickedHandler, int alternativesCount, Matrix matrix)
            : this(index, alternative, clickedHandler, alternativesCount)
        {
