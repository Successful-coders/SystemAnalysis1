            ...
            new Problem("Проблема перераспределения выделенного бюджета", "Описание отсутсвует", Status.Редактирование,
             ...
             new Problem("Проблема организации дальнейшего бесперебойного предоставления услуг населению банком",
              ...
              new Problem("Анализ результатов экономической деятельности корпорации",
                ...
                new Problem("Поиск наилучшего варианта закона для поддержки начинающих частных предпринимателей",
                    "Группе экспертов необходимо определить вариант нового закона, вводимого для поддержки начинающих частных предпринимателей. Были представлены следующие варианты проектов", Status.Редактирование,
                new List<Alternative>() {
                    new Alternative("предоставление льготных условий на получение кредита (льготный процент, значительная отсрочка погашения займа)", 0),
                    new Alternative("необложение предприятия налогами в течение двух лет", 1),
                    new Alternative("необложение налогами на прибыль в течение пяти лет", 2),
                },
                new List<Expert>() {
                    new Expert("Министрова Ольга", 8),
                    new Expert("Иванов Иван", 6),
                    new Expert("Павлов Виктор", 7),
                    new Expert("Кондратьев Игорь", 1),
                    new Expert("Воронкина Дарья", 2),
                    new Expert("Зайков Юрий", 3),
                }),
        };
